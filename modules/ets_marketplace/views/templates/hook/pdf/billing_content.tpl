				...
				<tr>
					...
					<td width="50%">
                        ...
                        {if $seller->vat_number}
                            <p style="margin:0;display:block;">{$seller->vat_number|escape:'html':'UTF-8'}</p>
                        {/if}
					</td>
				</tr>
            </table>
				...
				<tfoot>
                    {if $tax}
    					<tr>
    						...
    						<th class="product header small" style="padding:8px 10px;text-transform: uppercase;">{l s='Tax' mod='ets_marketplace'}</th>
    						<th class="product header small" style="background: #fff;padding:8px 10px">{$tax|escape:'html':'UTF-8'}</th>
    					</tr>
                    {/if}
                    <tr>
						<th class="" colspan="2" style="padding:8px 10px">&nbsp;</th>
						<th class="product header small" style="padding:8px 10px;text-transform: uppercase;">{l s='Total (Tax incl.)' mod='ets_marketplace'}</th>
						<th class="product header small" style="background: #fff;padding:8px 10px">{$billing_model->amount_tax|escape:'html':'UTF-8'}</th>
					</tr>
				</tfoot>
            </table>
        </td>
