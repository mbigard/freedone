...
*}
{if (isset($is_admin) && $is_admin) || ( (Configuration::get('ETS_MP_ALLOW_SELLER_CREATE_PRODUCT') && (!isset($has_duplicate_product) || $has_duplicate_product)) || (isset($has_edit_product) && $has_edit_product) || $has_delete_product)}
