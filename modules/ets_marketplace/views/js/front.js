...
$(document).ready(function(){
    $(document).on("click", function(event){
        if(!$(event.target).closest(".ets_mp_block-categories.block-categories.active").length && !$(event.target).closest(".ets_mp_block-categories_arrow.active").length){
            $(".ets_mp_block-categories.block-categories.active").removeClass("active");
            $(".ets_mp_block-categories_arrow.active").removeClass("active");
        }
    });
                        ...
                        $html += '<td class="text-right">';
                            $html += '<div class="btn-group-action">';
                                $html += '<div class="btn-group pull-right">';
                                    $html += '<a class="btn btn-default link_edit" href="'+json.link_edit+'"><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M491 1536l91-91-235-235-91 91v107h128v128h107zm523-928q0-22-22-22-10 0-17 7l-542 542q-7 7-7 17 0 22 22 22 10 0 17-7l542-542q7-7 7-17zm-54-192l416 416-832 832h-416v-416zm683 96q0 53-37 90l-166 166-416-416 166-165q36-38 90-38 53 0 91 38l235 234q37 39 37 91z"/></svg> '+Edit_text+'</a>';
                                    $html += '<button class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1408 704q0 26-19 45l-448 448q-19 19-45 19t-45-19l-448-448q-19-19-19-45t19-45 45-19h896q26 0 45 19t19 45z"/></svg></button>';
                                    $html += '<ul class="dropdown-menu"><li>';
                                        $html +='<a onclick="return confirm(\''+confirm_delete+'\');" href="'+json.link_delete+'"><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M704 1376v-704q0-14-9-23t-23-9h-64q-14 0-23 9t-9 23v704q0 14 9 23t23 9h64q14 0 23-9t9-23zm256 0v-704q0-14-9-23t-23-9h-64q-14 0-23 9t-9 23v704q0 14 9 23t23 9h64q14 0 23-9t9-23zm256 0v-704q0-14-9-23t-23-9h-64q-14 0-23 9t-9 23v704q0 14 9 23t23 9h64q14 0 23-9t9-23zm-544-992h448l-48-117q-7-9-17-11h-317q-10 2-17 11zm928 32v64q0 14-9 23t-23 9h-96v948q0 83-47 143.5t-113 60.5h-832q-66 0-113-58.5t-47-141.5v-952h-96q-14 0-23-9t-9-23v-64q0-14 9-23t23-9h309l70-167q15-37 54-63t79-26h320q40 0 79 26t54 63l70 167h309q14 0 23 9t9 23z"/></svg> '+Delete_text+'</a>';
                                    $html +='</li></ul>';
                                $html += '</div>';
                            $html += '</div>';
                        $html += '</td>';
    ...
    $(document).on('click','.checkbox input',function(){
        ...
        var default_category_ele = $(this).closest('ul.category-tree').find('input[name="id_category_default"]');
        if($(this).is(':checked'))
        {
            ...
            if ($(this).attr('type') == 'checkbox') {
                var hasCheckedDefault = false;
                default_category_ele.each(function(){
                    if ($(this).is(':checked'))
                        hasCheckedDefault = true;
                });
                if (!hasCheckedDefault) {
                    $(this).siblings('input[name="id_category_default"]').prop("checked", true);
                }
            }
            if ($(this).attr('type') == 'radio') {
                $(this).siblings('input[name="id_categories[]"]').prop("checked", true);
            }
        }
        else
        {
            $(this).closest('.form-group').find('.checkbox_all input').prop('checked',false);
            if ($(this).attr('type') == 'checkbox' && $(this).closest('li').find('input[name="id_category_default"]').is(':checked')) {
                $(this).siblings('input[name="id_category_default"]').prop("checked", false);
                var checkdefault = false;
                $(this).closest('ul.category-tree').find('input[name="id_categories[]"]').each(function() {
                    if ($(this).is(':checked') && !checkdefault) {
                        $(this).siblings('input[name="id_category_default"]').prop("checked", true);
                        checkdefault = true;
                    }
                });
        ...
        $.ajax({
            ...
            success: function(json){    
                 ...
                 if(json.success)
                 {
                    ...
                    $('.total_follow > span').html(($('.total_follow').prev('.total').length ? '':'')+json.total_follow);
                 }                                      
            },
            error: function(error)
            {   
            ...
            success: function(json){ 
                ...
                if(json.success)
                {
                    if(json.enabled=='1')
                    {
                        ...
                        $this.html('<svg width="14" height="14" style="fill:#00d200!important;" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1671 566q0 40-28 68l-724 724-136 136q-28 28-68 28t-68-28l-136-136-362-362q-28-28-28-68t28-68l136-136q28-28 68-28t68 28l294 295 656-657q28-28 68-28t68 28l136 136q28 28 28 68z"/></svg>');
                    }                        
                    else
                    {
                    ...
                    if(json.success)
                    {
                        ...
                        if($this.prev('.alert').length)
                           $this.prev('.alert').html(json.success);
                            ...
                            $('.alert.alert-success').html('<svg width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1412 734q0-28-18-46l-91-90q-19-19-45-19t-45 19l-408 407-226-226q-19-19-45-19t-45 19l-91 90q-18 18-18 46 0 27 18 45l362 362q19 19 45 19 27 0 46-19l543-543q18-18 18-45zm252 162q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z"/></svg>'+json.success);
                        else if($('.alert.alert-info').length)
                            $('.alert.alert-info').html('<svg width="20" height="20" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1152 1376v-160q0-14-9-23t-23-9h-96v-512q0-14-9-23t-23-9h-320q-14 0-23 9t-9 23v160q0 14 9 23t23 9h96v320h-96q-14 0-23 9t-9 23v160q0 14 9 23t23 9h448q14 0 23-9t9-23zm-128-896v-160q0-14-9-23t-23-9h-192q-14 0-23 9t-9 23v160q0 14 9 23t23 9h192q14 0 23-9t9-23zm640 416q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z"/></svg>'+json.success);
                        else
...
$(document).on('click','#delete-combinations',function(e){
    ...
    if(!$(this).hasClass('loading'))
    {
        if($('.js-combination:checked').length==0)
            alert('Please select product attribute' +
                '');
        else
        {
            if(confirm("Are you sure to delete this?"))
        ...
        $.ajax({
            ...
            success: function(json){ 
                ...
                if(json.success)
                {
                    ...
                    $html_tr += '<td class="ets-special-edit"><a class="js-delete delete btn ets_mp_delete_specific delete pl-0 pr-0" title="Delete" href="#" data-id_specific_price="'+json.specific.id_specific_price+'"><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M704 736v576q0 14-9 23t-23 9h-64q-14 0-23-9t-9-23v-576q0-14 9-23t23-9h64q14 0 23 9t9 23zm256 0v576q0 14-9 23t-23 9h-64q-14 0-23-9t-9-23v-576q0-14 9-23t23-9h64q14 0 23 9t9 23zm256 0v576q0 14-9 23t-23 9h-64q-14 0-23-9t-9-23v-576q0-14 9-23t23-9h64q14 0 23 9t9 23zm128 724v-948h-896v948q0 22 7 40.5t14.5 27 10.5 8.5h832q3 0 10.5-8.5t14.5-27 7-40.5zm-672-1076h448l-48-117q-7-9-17-11h-317q-10 2-17 11zm928 32v64q0 14-9 23t-23 9h-96v948q0 83-47 143.5t-113 60.5h-832q-66 0-113-58.5t-47-141.5v-952h-96q-14 0-23-9t-9-23v-64q0-14 9-23t23-9h309l70-167q15-37 54-63t79-26h320q40 0 79 26t54 63l70 167h309q14 0 23 9t9 23z"/></svg> Delete</a><a class="js-edit edit btn tooltip-link delete pl-0 pr-0" title="Edit" href="#" data-id_specific_price="'+json.specific.id_specific_price+'"><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M491 1536l91-91-235-235-91 91v107h128v128h107zm523-928q0-22-22-22-10 0-17 7l-542 542q-7 7-7 17 0 22 22 22 10 0 17-7l542-542q7-7 7-17zm-54-192l416 416-832 832h-416v-416zm683 96q0 53-37 90l-166 166-416-416 166-165q36-38 90-38 53 0 91 38l235 234q37 39 37 91z"/></svg> Edit</a></td>';
...
$(document).ready(function(){
    ...
    if($('#ets_mp_temp_link_registration').length>0)
    {
        ...
        $('#ets_mp_temp_link_registration').on('click',function(){
            if($(this).is(':checked'))
            {
                $('#submitSeller').removeAttr('disabled');
            }
    ...
    $('#tabOrder a').on('click',function (e) {
        e.preventDefault();
    ...
    $('#myTab a').on('click',function (e) {
      ...
      $('#tabAddresses a').on('click',function (e) {
        e.preventDefault();
...
var etsMPAddProudctCartRule = function(event,data,formatted)
{
    ...
    {
       $('#productFilter').before('<div class="product_selected">'+data[2]+' <span class="delete_product_search"></span><div>');
       $('#productFilter').val(''); 
    }
}
var etsMPAddProductPack = function(event, data, formatted)
{
    ...
    var $html = '<li class="col-xl-3 col-lg-6 mb-1" data-product="'+data[0]+'-'+data[1]+'">';
        $html +='<div class="pack-product">';
            ...
            $html += '<svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M704 736v576q0 14-9 23t-23 9h-64q-14 0-23-9t-9-23v-576q0-14 9-23t23-9h64q14 0 23 9t9 23zm256 0v576q0 14-9 23t-23 9h-64q-14 0-23-9t-9-23v-576q0-14 9-23t23-9h64q14 0 23 9t9 23zm256 0v576q0 14-9 23t-23 9h-64q-14 0-23-9t-9-23v-576q0-14 9-23t23-9h64q14 0 23 9t9 23zm128 724v-948h-896v948q0 22 7 40.5t14.5 27 10.5 8.5h832q3 0 10.5-8.5t14.5-27 7-40.5zm-672-1076h448l-48-117q-7-9-17-11h-317q-10 2-17 11zm928 32v64q0 14-9 23t-23 9h-96v948q0 83-47 143.5t-113 60.5h-832q-66 0-113-58.5t-47-141.5v-952h-96q-14 0-23-9t-9-23v-64q0-14 9-23t23-9h309l70-167q15-37 54-63t79-26h320q40 0 79 26t54 63l70 167h309q14 0 23 9t9 23z"/></svg>';
            $html += '</button>';
        $html += '</div>';
    $html +='</li>';
...
var etsMPAddProductRelated = function(event, data, formatted)
{
    ...
    var $html = '<li class="media">';
        ...
        $html +='<div class="media-body media-middle">';
            ...
            $html +='<svg width="14" height="14" style="fill:red!important;" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1490 1322q0 40-28 68l-136 136q-28 28-68 28t-68-28l-294-294-294 294q-28 28-68 28t-68-28l-136-136q-28-28-28-68t28-68l294-294-294-294q-28-28-28-68t28-68l136-136q28-28 68-28t68 28l294 294 294-294q28-28 68-28t68 28l136 136q28 28 28 68t-28 68l-294 294 294 294q28 28 28 68z"/></svg>';
        $html +='</div>';
    ...
    if($('#product_type').length>0)
    {
        ...
        if(product_type==0 || product_type==1)
        {
            ...
            if(product_type==0)
            {
                ...
                $('input[name="show_variations"]').on('click',function(){
                    if($(this).val()==1)
                    {
                        $('.ets_mp_tab[data-tab="Combinations"]').show();
                        $('.ets_mp_tab[data-tab="Quantities"]').hide();
        ...
        else
        {
            ...
            $('input[name="is_virtual_file"]').on('click',function(){
                if($(this).val()==1)
                    $('#virtual_product_content').show();
                else
                    $('#virtual_product_content').hide();
...
function ets_mp_readShopLogoURL(input){
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            {
                $(input).parents('.ets_upload_file_custom').before('<div class="shop_logo"><img class="ets_mp_shop_logo" src="'+e.target.result+'" width="150px"><a class="btn btn-default delete_logo_upload" href=""><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M704 1376v-704q0-14-9-23t-23-9h-64q-14 0-23 9t-9 23v704q0 14 9 23t23 9h64q14 0 23-9t9-23zm256 0v-704q0-14-9-23t-23-9h-64q-14 0-23 9t-9 23v704q0 14 9 23t23 9h64q14 0 23-9t9-23zm256 0v-704q0-14-9-23t-23-9h-64q-14 0-23 9t-9 23v704q0 14 9 23t23 9h64q14 0 23-9t9-23zm-544-992h448l-48-117q-7-9-17-11h-317q-10 2-17 11zm928 32v64q0 14-9 23t-23 9h-96v948q0 83-47 143.5t-113 60.5h-832q-66 0-113-58.5t-47-141.5v-952h-96q-14 0-23-9t-9-23v-64q0-14 9-23t23-9h309l70-167q15-37 54-63t79-26h320q40 0 79 26t54 63l70 167h309q14 0 23 9t9 23z"/></svg></a></div>');
