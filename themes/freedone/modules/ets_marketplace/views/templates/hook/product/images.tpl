...
<div id="product-images-container"{if $product_class->id} style="display:block"{else} style="display:none;"{/if}>
    <div id="product-images-dropzone" class="panel dropzone ui-sortable {if $images}dz-started{/if} col-md-12" style="">
        ...
        <div class="preco"><p><strong>{l s='Pour des raisons esthétiques et pour optimiser la présentation de vos créations sur notre plateforme, utilisez uniquement des images de dimensions carrées 2500x2500 pixels.' mod='ets_marketplace'}</strong></p>
          <p>
            <br/>{l s='- Vos images doivent être au format JPEG impérativement' mod='ets_marketplace'}
            <br/>{l s='- Assurez-vous que le poids de vos images ne dépasse pas 1 Mo' mod='ets_marketplace'}
            <br/>{l s='- Vous pouvez utiliser les service' mod='ets_marketplace'} <a href="https://compressjpeg.com" target="_blank">de ce site</a> {l s='pour compresser vos images' mod='ets_marketplace'}
            <br/>{l s='- Aidez-vous de notre tutoriel' mod='ets_marketplace'} <a href="https://www.youtube.com/watch?v=6uodbeBrilk&t=1s" target="_blank">en cliquant ici</a>
          </p>
        </div>
