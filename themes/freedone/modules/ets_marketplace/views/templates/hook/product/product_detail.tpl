...
<div class="mp_shop_seller_detail">
    <div class="mp_left_content">
        <div class="information-vendeur">{l s='Crée et vendu par' mod='ets_marketplace'}</div>
        <div class="shop_name">{$shop_name|escape:'html':'UTF-8'}</div>
        <div class="shop_logo"><img src="{$link->getMediaLink("`$smarty.const.__PS_BASE_URI__`img/mp_seller/`$logo_seller|escape:'htmlall':'UTF-8'`")}" width="80px" alt="{$shop_name|escape:'html':'UTF-8'}"/></div>
        <a class="shop_link" href="{$link_shop_seller|escape:'html':'UTF-8'}">
            ...
            <div class="product product_review_shop">
                ...
                {if $total_products && $total_reviews}
                    <div class="ets_review col">
                        ...
                        <div class="ets_review_total">{for $foo=1 to $total_reviews_int}★{/for}{if $total_reviews_int < $total_reviews}★{for $foo= $total_reviews_int+2 to 5}☆{/for}{else}{for $foo= $total_reviews_int+1 to 5}☆{/for}{/if}
                        </div>
