...
*}
{assign var=uid value=10|mt_rand:100000}

<div class="gdpr_consent gdpr_module_{$uid}">
    <span class="custom-checkbox">
        <label class="psgdpr_consent_message">
            <input id="psgdpr_consent_checkbox_{$uid}"
...
{literal}
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            let psgdpr_id_module = "{/literal}{$uid}{literal}";
                ...
                $(document).on('submit', parentForm, function(event) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            id_module: {/literal}{$psgdpr_id_module|escape:'htmlall':'UTF-8'}{literal},
                        },
