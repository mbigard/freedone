            ...
            <div class="col-md-{$sizeCol_md} {$offsetCol_md} col-sm-{$sizeCol_sm} {$offsetCol_sm} col-xs-12"
                ...
                <div class="block-icon">
                    {if $block['icon'] != 'undefined'}
                        {if $block['icon']}
                            <img class="svg invisible" src="{$urls.base_url}{$block['icon']}" alt="reassuarence-icon" width="30" height="30">
                        {elseif $block['custom_icon']}
                            <img src="{$urls.base_url}{$block['custom_icon']}" alt="reassuarence-customicon" width="30" height="30">
                        {/if}
                    {/if}
                </div>
