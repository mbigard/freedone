    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          <div class="row">
              ...
              {if isset($product) && $product}
                ...
                {block name='product_cover'}
                  <div class="product-cover">
                    {if $product.cover}
                      <img class="js-qv-product-cover w-100" src="{$product.cover.bySize.medium_default.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}">
                    {else}
                      <img src="{$urls.no_picture_image.bySize.large_default.url nofilter}" class="w-100">
                    {/if}
                  </div>
                {/block}
              {/if}
            ...
            <div class="col-md-6 col-sm-6">
              ...
              {block name='product_description_short'}
                <div class="comment-desc">{$product.description_short nofilter}</div>
              {/block}
            </div>
          ...
          <div class="row">
            {if !$logged}
              <div class="col-md-8 col-sm-8">
                <label class="form-label">{l s='Title' d='Modules.Productcomments.Shop'}<sup class="required">*</sup></label>
              </div>
              <div class="col-md-4 col-sm-4">
                <label class="form-label">{l s='Your name' d='Modules.Productcomments.Shop'}<sup class="required">*</sup></label>
              </div>
            {else}
            ...
            {if !$logged}
              <div class="col-md-8 col-sm-8">
                <div class="relative">
                    ...
                    <input class="form-control" name="comment_title" type="text" value="" placeholder="{l s='Great delivery service' d='Modules.Productcomments.Shop'}" required="">
              ...
              <div class="col-md-4 col-sm-4">
                <div class="relative">
                    <div class="icon-false">
                    <input class="form-control" name="customer_name" type="text" value="" placeholder="{l s='Frank' d='Modules.Productcomments.Shop'}" required="">
                    <span class="focus-border"><i></i></span>
                    </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <label class="form-label">{l s='Review' d='Modules.Productcomments.Shop'}<sup class="required">*</sup></label>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 col-sm-12">
