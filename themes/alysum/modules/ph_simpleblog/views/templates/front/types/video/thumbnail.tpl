...
{if isset($post.banner) && Configuration::get('PH_BLOG_DISPLAY_THUMBNAIL')}
	<div class="post-thumbnail" itemscope itemtype="http://schema.org/ImageObject">
		<a href="#simpleblog-post-{$post.id_simpleblog_post|intval}-video" title="{l s='Permalink link to' d='Modules.Phsimpleblog.Shop'} {$post.title|escape:'html':'UTF-8'}" itemprop="url">
