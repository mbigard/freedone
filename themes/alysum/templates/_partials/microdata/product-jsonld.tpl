...
{assign var=ratingValue value=5}
{assign var=ratingReviewCount value=1}
...
<script type="application/ld+json">
  {
    ...
    ,"aggregateRating": {
      ...
      "ratingValue": "{($ratingValue == 0) ? 5 : $ratingValue|round:1|escape:'html':'UTF-8'}",
      "reviewCount": "{($ratingValue == 0) ? 1 : $ratingReviewCount|escape:'html':'UTF-8'}"
    }
    {if $hasWeight},
    "weight": {
        "@context": "https://schema.org",
