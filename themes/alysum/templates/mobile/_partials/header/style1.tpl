...
<header class="m20 general-item style1">
  ...
  <div class="main-menu">
    {include file='mobile/_partials/button-toggler.tpl' togglerId='selector-menu' togglerIcon='burger' togglerTitle={l s='Menu' d='Shop.Theme.Amp'} togglerClass='clear-button reverse-order w100 text-uppercase'}
  </div>
