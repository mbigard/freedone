...
<div class="container">
    ...
    <section class="form-fields flex-container password-recovery-form">
      ...
      <label>
        <input type="password" data-validate="isPasswd" name="passwd" value="" placeholder="{l s='New password' d='Shop.Forms.Labels'}">
      </label>

      <label>
        <input type="password" data-validate="isPasswd" name="confirmation" value="" placeholder="{l s='Confirmation' d='Shop.Forms.Labels'}">
      </label>
