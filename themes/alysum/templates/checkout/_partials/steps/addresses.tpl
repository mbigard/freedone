        ...
        <form method="POST" action="{url entity='order' params=['id_address' => $id_address]}"
            ...
            {elseif $customer.addresses|count > 0}
                ...
                <p class="add-address">
                    ...
                    </svg>{l s='Add new address' d='Shop.Theme.Actions'}
                    </a>
                </p>
                ...
                {else}
                    ...
                    {if isset($invoice_address_error)}
                        <p class="alert alert-danger js-address-error" name="alert-invoice"
                            id="id-failure-address-{$invoice_address_error.id_address}">
            ...
            {if !$form_has_continue_button}
                <div class="clearfix">
                    ...
                    <input type="hidden" id="not-valid-addresses"
                        value="{if (isset($not_valid_addresses))}{$not_valid_addresses}{/if}">
                </div>
            {/if}
